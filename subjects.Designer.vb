...
Partial Class SubjectForm
    ...
    Private Sub InitializeComponent()
        ...
        DataGridViewCellStyle1.Font = New Font("Calibri", 20.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        DataGridViewCellStyle1.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle1.Padding = New Padding(5)
        DataGridViewCellStyle1.SelectionBackColor = SystemColors.Highlight
        DataGridViewCellStyle1.SelectionForeColor = SystemColors.HighlightText
        DataGridViewCellStyle1.WrapMode = DataGridViewTriState.True
        dgvSubjectTable.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle1
        ...
        dgvSubjectTable.DefaultCellStyle = DataGridViewCellStyle2
